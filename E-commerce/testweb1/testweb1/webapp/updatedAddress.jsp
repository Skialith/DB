...
<div class="content">
    <div class="content_header">
        <div class="title h5-u">Update Record_image Address</div>
        <div class="subTitle p-u">Please update Address</div>
    </div>
    <form method="post" action="./updatedAddress" class="content_form">
        <div class="form_item">
            <label for="name">updated Address :</label>
            <input type="text" name="updatedAddress" id="name"/><br/>
        </div>
        <div class="form_item">
